        ...
        <div class="wrap-login100">
            ...
            <form class="login100-form validate-form" method="POST">
                ...
                <div class="flex-sb-m w-full p-b-30">
                    ...
                    <div>
                        <a href="<?php echo site_url()?>account/login" class="txt1">
                           Have account ?
                        </a>
                    </div>
                </div>
        ...
        $('.validate-form').on('submit',function(e){
            ...
            $.post("<?php echo site_url()?>auth/register", data ).then(res => {
                $.toast({
                    ...
                    text: "<span class='my-2' style='font-size: 18px;'><b>Registration success, <a href='<?php echo site_url()?>account/login'>click here</a> to login</b>", 
                    icon: 'success',
